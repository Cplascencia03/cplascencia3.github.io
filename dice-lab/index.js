...
// Report the outcome and current balance:
  banner = die1 + " + " + die2 + " is: " + dieSum;
  document.querySelector("h3").innerHTML = banner + "<br>" + outcome + "<br>Current Balance: $" + balance;
}

//function letsPlay() {
  // Ask the user for input on the number of times to play
  //var userInput = prompt("How many times do you want to play?");
  
  // Validate the user input
  //if (userInput !== null && userInput !== "" && !isNaN(userInput) && userInput > 0) {
